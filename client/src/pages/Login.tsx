        ...
        >
          <div className="text-center mb-8">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-emergency mb-4"
            >
          ...
          <div className="mt-6 p-4 rounded-xl bg-warning/10 border border-warning/30 flex items-start gap-3">
            ...
            <p className="text-xs text-muted-foreground">
              This app requires access to your location, phone, and SMS to provide emergency assistance. You'll be asked for permissions after login.
            </p>
          </div>
        </motion.div>
      </div>
